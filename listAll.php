...
require_once("document.php");
 ...
 $documents=$document->getAllByVerified();
 $nbr=count($documents);
    ...
    <div class='col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0   '>
            <div class='course-item' >
              ...
              <div class='course-content' >
                ...
                <h3><a href='course_details2.php?dd=$row[0].php'>$row[2]</a></h3>
                <p >$NewString</p>
                <div class='trainer d-flex justify-content-between align-items-center'>
                  ...
                  <a href='download_action.php?file=$row[6]&dd=$row[0]&id=$id' class='bouton2'>
                  <i class='bx bx-download'></i>&nbsp;$nbr1 </a>
                    &nbsp;&nbsp;
                    <a href='favorite_action.php?dd=$row[0]' class='bouton2'>
